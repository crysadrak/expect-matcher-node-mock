...
function toHaveBeenCalled(receivedMethod) {
  const { matcherName, options, expectedText } = matcherFactory(
    'toHaveBeenCalled',
    this
  );
...
function toHaveBeenCalledTimes(receivedMethod, expected) {
  ...
  const options = {
    comment: 'toHaveBeenCalledTimes of Node.js mock.fn()',
    isNot: this.isNot,
      ...
      return {
        ...
        message: () => {
          return `${matcherHint(
            ...
            'expected',
            options
          )}\n\nExpected number of calls: not ${EXPECTED_COLOR(
            receivedMethod.mock.calls.length
          )}\n`;
        },
      };
...
function toHaveBeenCalledWith(receivedMethod, ...args) {
  ...
  const options = {
    comment: 'toHaveBeenCalledWith of Node.js mock.fn()',
    isNot: this.isNot,
    promise: this.promise,
  };
